...
_C.ACTIVE.STATE = False
_C.ACTIVE.RATE = 0.032
_C.ACTIVE.MODEL_SELECTION = "LR"
_C.ACTIVE.MODEL_SELECTION_CHOICE = [1e-3, 3e-3, 5e-3, 1e-2]
_C.ACTIVE.LR = 1e-5
_C.ACTIVE.MODEL_SELECTION_MOMENTUM=0.5
...
_C.RMT.LAMBDA_CE_SRC = 0.0 # default 1.0
_C.RMT.LAMBDA_CE_TRG = 1.0
_C.RMT.LAMBDA_CONT = 1.0
_C.RMT.NUM_SAMPLES_WARM_UP = 0 # default 50000
...
_C.SAR.RESET_CONSTANT_EM = 0.0

# --------------------------------- SIMATTA options ---------------------------- #
_C.SIMATTA = CfgNode()


_C.SIMATTA.MAX_ANCHOR = 50
_C.SIMATTA.E_L = 1e-3
_C.SIMATTA.E_U = 1e-2
...
def get_num_classes(dataset_name):
    dataset_name2num_classes = {"cifar10": 10, "cifar10_c": 10, "cifar100": 100,  "cifar100_c": 100,
                                ...
                                "domainnet126": 126, "office31": 31, "visda": 12, "pacs": 7, "office-home": 65,
                                }
